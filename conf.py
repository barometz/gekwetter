...
BLOG_AUTHOR = "Dominic van Berkel"  # (translatable)
...
BASE_URL = SITE_URL
BLOG_EMAIL = "gekwetter@baudvine.net"
BLOG_DESCRIPTION = "Digital and analog tinkerings of Dominic van Berkel"  # (translatable)
...
#        ("/rss.xml", "RSS feed"),
        ("/pages/datasheet.html", "My datasheet"),
    ),
}
...
# This is kind of an abuse of what is described as "a small copyright notice".
# May muck around in footer.tmpl at some point.

social_list = [
    { "title": "Email me", "href": "mailto:" + BLOG_EMAIL,
      "alt": "Email", "img": "email-icon.png" },
    { "title": "Follow me on GitHub", "href": "https://github.com/barometz",
      "alt": "GitHub", "img": "github-mark.png" },
    { "title": "Follow me on Twitter", "href": "https://twitter.com/baudvine",
      "alt": "Twitter", "img": "twitter-logo.png" },
    { "title": "Connect on LinkedIn", "href": "https://www.linkedin.com/in/dvberkel",
      "alt": "LinkedIn", "img": "linkedin-in.png" },
    { "title": "Follow the blog via RSS", "href": "/rss.xml",
      "alt": "RSS", "img": "rss-feed.png" },
]

social_link = '<a href="{{href}}"><img src="{baseurl}/{{img}}" alt="{{alt}}" title="{{title}}"></a>'
social_link = social_link.format(baseurl=BASE_URL + "/static-img")
